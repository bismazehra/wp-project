...
final class Plugin {
    ...
    public function __construct() {
        ...
        add_filter( 'the_content', [$this, 'the_content'], -99, 1 );
    }
    ...
    /**
     * Modify The content for Form HTML support
     * @since 4.3.0
     *
     * @return string
     */
    public function the_content( $content ) {
        ...
        $formBlocks = Helper::array_filter_recursive( $blocks, 'essential-blocks/form' );
